...
<!-- Source: internal/storage/metadb/migrations/000001_init.up.sql — change that, then run `make docs`. -->
...
| `schedules`     | 16      | yes           | tenants, instances |
| `jobs`          | 19      | yes           | tenants, schedules, instances, users |
| `backups`       | 24      | yes           | tenants, instances, jobs, schedules, users |
